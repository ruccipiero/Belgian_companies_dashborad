...
with a1:
    ...
    fig = px.bar(LanguageSearch_df, y='PercentageDenominationLanguage', x='Language',
        text="PercentageDenominationLanguage", color='Language' )
    fig.update_yaxes(title_text='Percentage of languages')
    fig.update_xaxes(title_text='Language', categoryorder='array', categoryarray= ['Dutch', 'French', 'unknown','English', 'Germany'])
